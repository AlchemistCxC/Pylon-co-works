...
- [Codex] #155 T3：隔离工作树 codex/issue-155-t3；pylon-session draft 存储/迁移、canonical feed 与 Workbench 草稿投影、对应测试和说明书。dispatcher/canonical_flush.rs 与 Workbench 现由 #334-336/#324 在途，隔离分支实现后再对齐合入。
