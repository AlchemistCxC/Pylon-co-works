...
**「三菜单 + 窗口控制位置恒定 + 折叠按钮位置不变」的实机证明**（1200×800）

| 元素 | 改动前基线 | 现在·展开 | 现在·折叠 |
|---|---|---|---|
| 折叠按钮 | x=0 w=42 | x=0 w=42 | **x=0 w=42** |
| 三灯 | x=58 | x=58 | 隐藏 |
| 标题栏左格 | 0..240 | 0..240 | 0..42（无右边框） |
...
| sheet tab 起点 | 240 | 240 | 42（紧随按钮） |

即：折叠按钮与右侧两簇在展开/折叠两态下**逐项不变**，折叠只改变正文左列与三灯。
