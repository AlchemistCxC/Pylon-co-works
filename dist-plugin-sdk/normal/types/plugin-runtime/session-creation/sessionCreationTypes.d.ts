export type SessionCreationJson = null | boolean | number | string | readonly SessionCreationJson[] | {
...
export type SessionCreationPayloadResolver = (context: SessionCreationContext) => SessionCreationJson | null | undefined;
/**
...
export interface SessionCreationCompiler {
    ...
    readonly kind: string;
    readonly order?: number;
    compile(contribution: ResolvedSessionCreationContribution, context: SessionCreationContext): readonly SessionCreationArtifactDraft[];
}
...
export interface SessionCreationArtifactHandler {
    ...
    readonly kind: string;
    readonly order?: number;
    run(artifact: SessionCreationArtifactSnapshot, context: SessionCreationPhaseContext): void | readonly SessionCreationPhaseEffect[] | Promise<void | readonly SessionCreationPhaseEffect[]>;
}
