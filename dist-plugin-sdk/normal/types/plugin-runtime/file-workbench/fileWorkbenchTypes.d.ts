...
import type { WorkspaceEntry, WorkspaceTextPreview } from '../../components/right-panel/rightPanelTypes.js';
import type { WorkspaceSearchResult } from '../../infrastructure/tauri/workspaceSearchContracts.js';
import type { GitCommit, GitOperationResult, GitStatusWithBranch } from '../../infrastructure/tauri/gitContracts.js';
import type { WorkspaceTarget } from '../../domains/workspace/workspaceTarget.js';
import type { FileTabRecord } from '../../sheets/file/fileSheetState.js';
...
export interface FileProvider {
    ...
    writeText?(target: WorkspaceTarget, input: {
        relativePath: string;
        content: string;
        expectedBaseline?: string | null;
        force?: boolean;
    }, signal?: AbortSignal): Promise<WorkspaceTextPreview | null>;
...
export interface GitProvider {
    ...
    history(target: WorkspaceTarget, options?: {
        limit?: number;
    }, signal?: AbortSignal): Promise<GitCommit[]>;
    diff(target: WorkspaceTarget, input: {
        path: string;
        staged: boolean;
...
export type FileWorkbenchContribution = FileActivityContribution | ({
    kind: 'file-provider';
    ...
    kind: 'language-provider';
    provider: FileLanguageProvider;
    id: string;
    priority: number;
    fallback: boolean;
}) | ({
