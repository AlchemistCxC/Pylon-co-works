import type { MessageRenderer } from '../../contracts/messageRenderer.js';
import type { AnsiProvider, ContentPartProvider, FooterProvider, PlanProvider, SpinnerProvider } from '../../contracts/rendererContentPoints.js';
import type { ToolKind } from '../../domains/tool/toolKinds.js';
import type { RendererSettingsPlacement, RendererSettingsSchema } from './rendererSettingsTypes.js';
...
export type ContentRendererProvider = AnsiProvider | SpinnerProvider | ContentPartProvider | PlanProvider | FooterProvider;
