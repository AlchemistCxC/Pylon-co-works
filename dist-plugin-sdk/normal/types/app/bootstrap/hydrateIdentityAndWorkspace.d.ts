import type { ProfilePersistenceState } from '../../profilePersistence.js';
...
export declare function reportLegacyProfilePayload(payload: ProfilePersistenceState | undefined): void;
export declare function consumeLegacyProfilePayload(): ProfilePersistenceState | undefined;
/** Test/HMR seam: clears completed stage memory after an application teardown. */
export declare function resetHydrationCoordinator(): void;
/**
 * ISSUE-01 启动身份水合事务。
 *
 ...
 */
export declare function hydrateIdentityAndWorkspace(legacy?: ProfilePersistenceState): Promise<HydrationResult>;
