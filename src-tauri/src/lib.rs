...
#[tauri::command]
async fn prism_health(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    state.prism.get("/health").await.map_err(PylonError::Prism)
}

#[tauri::command]
async fn prism_status(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    Ok(state.prism.status().await)
}

#[tauri::command]
async fn prism_state(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    state.prism.get("/state").await.map_err(PylonError::Prism)
}

#[tauri::command]
async fn prism_scenarios(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    state.prism.get("/api/scenarios").await.map_err(PylonError::Prism)
}

#[tauri::command]
async fn prism_sources(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    state.prism.get("/api/sources").await.map_err(PylonError::Prism)
}

#[tauri::command]
async fn prism_aliases(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
...
#[tauri::command]
async fn prism_blocks(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
...
#[tauri::command]
async fn prism_reload(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
    state.prism.post("/reload", serde_json::json!({})).await.map_err(PylonError::Prism)
}

#[tauri::command]
async fn prism_llm_test(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, PylonError> {
...
#[tauri::command]
async fn validate_agents() -> Result<serde_json::Value, PylonError> {
