...
export const THEME_FIELD_DEFS = {
  ...
  transparency: { ...N('global', '透明度', 0, 1, 0.05), group: "玻璃效果" },
  bgBlur: { ...N('global', '模糊', 0, 40, 2), group: "玻璃效果" },
  globalFont: { ...S('global', '字体', ['system', 'mono']), group: "字体" },
  globalFontSize: { ...N('global', '基础字号', 12, 24), group: "字体" },
  ...
  spinnerSize: { ...N('chat', 'Spinner 大小', 10, 32), group: "Spinner" },
  ...
  ccStatusFontSize: { ...N('cc', '信息字号', 14, 20), group: "中控背景" },
  ...
  inputFontSize: { ...N('cc', '输入字号', 12, 22), group: "输入与状态" },
  inputMinHeight: { ...N('cc', '输入最小高', 32, 120), group: "输入与状态" },
  ...
  cliLineWidth: { ...N('cc', 'CLI 线宽', 1, 4), group: "输入与状态" },
  cliLineColor: { ...C('cc', 'CLI 线色'), group: "输入与状态" },
  cliTextColor: { ...C('cc', 'CLI 文字'), group: "输入与状态" },
  cliPromptColor: { ...C('cc', '提示符颜色'), group: "控件样式" },
  cliLinePadding: { ...N('cc', 'CLI 内边距', 0, 16), group: "输入与状态" },
  cliContentOffsetY: { ...N('cc', '内容垂直偏移', -6, 6), group: "控件样式" },
  ...
  ekgWidth: { ...N('cc', '波形宽度', 60, 300), group: "波形与用量" },
  ekgFontSize: { ...N('cc', '波形字号', 10, 24), group: "波形与用量" },
  ekgGreen: { ...C('cc', '波形·正常'), group: "波形与用量" },
  ekgYellow: { ...C('cc', '波形·警示'), group: "波形与用量" },
  ekgRed: { ...C('cc', '波形·危险'), group: "波形与用量" },
  ekgLineWidth: { ...N('cc', '波形线宽', 1, 6), group: "波形与用量" },
  ekgAmplitudeMax: { ...N('cc', '波形幅度', 2, 40), group: "波形与用量" },
  ...
  rightWidth: { ...N('right', '宽度', 200, 400), group: "外观" },
  rightTransparency: { ...N('right', '透明度', 0, 1, 0.05), group: "玻璃效果" },
  rightBlur: { ...N('right', '模糊', 0, 40, 2), group: "玻璃效果" },
