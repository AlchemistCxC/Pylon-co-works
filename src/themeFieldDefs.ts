...
export const THEME_FIELD_DEFS = {
  ...
  ekgWidth: { ...N('cc', '波形宽度', 60, 300), default: 150, group: "波形与用量", unit: 'px' },
  ekgFontSize: { ...N('cc', '波形字号', 10, 24), default: 16, group: "波形与用量", unit: 'px' },
  ...
  ekgLineWidth: { ...N('cc', '波形线宽', 1, 6), default: 3, group: "波形与用量", unit: 'px', advanced: true },
  ekgAmplitudeMax: { ...N('cc', '波形幅度', 2, 40), default: 10, group: "波形与用量", unit: 'px', advanced: true },
  ekgSpeedBase: { ...N('cc', '波形速度基', 0.1, 2, 0.1), default: 0.5, group: "波形与用量", advanced: true },
  ekgSpeedMax: { ...N('cc', '波形速度峰', 0.5, 6, 0.1), default: 2.0, group: "波形与用量", advanced: true },
  ekgLeftColor: { ...C('cc', '波形·左色'), default: 'rgba(0,0,0,0.35)', group: "波形与用量", advanced: true },
  ekgMovingColor: { ...C('cc', '波形·动色'), default: '', group: "波形与用量", advanced: true },
