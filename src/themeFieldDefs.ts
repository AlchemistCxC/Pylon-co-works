...
export const THEME_FIELD_DEFS = {
  ...
  globalBgColor: { ...C('global', '背景底色'), tier: 'basic', default: '#e8e8ec', group: "玻璃效果", hint: '背景图或透明材质下方使用的基础颜色' },
  uiScheme: { ...S('global', '界面明暗', ['light', 'dark']), tier: 'basic', default: 'light', group: "玻璃效果", control: 'schemeChip' },
  titlebarBg: { ...C('global', '标题栏背景'), default: '', group: '标题栏', cssVar: '--titlebar-bg', hint: '留空时跟随当前浅色/深色基础配色' },
  titlebarTextColor: { ...C('global', '标题栏文字'), default: '', group: '标题栏', cssVar: '--titlebar-text', hint: '留空时跟随当前界面文字颜色' },
  ...
  toolOk: { ...C('chat', '工具完成状态'), default: '#4EBA65', group: "指示器与连接线", },
  toolRun: { ...C('chat', '工具运行状态'), default: '#93A5FF', group: "指示器与连接线", },
  toolErr: { ...C('chat', '工具错误状态'), default: '#FF6B80', group: "指示器与连接线", },
  userTagBg: { ...C('chat', '用户标签背景'), default: 'rgba(168,85,247,0.08)', group: "用户标签", },
  userTagText: { ...C('chat', '用户标签文字'), default: '#a855f7', group: "用户标签", },
  diffAdded: { ...C('chat', '新增行'), default: '#4EBA65', group: "代码差异", },
  diffRemoved: { ...C('chat', '删除行'), default: '#FF6B80', group: "代码差异", },
  ...
  toolConnectorColor: { ...C('chat', '连接线颜色'), default: 'rgba(0,0,0,0.12)', group: "指示器与连接线", showIf: t => t.toolConnectorMode === 'fixed' },
  ...
  spinnerStalledColor: { ...C('chat', '长时间等待颜色'), default: '#FF6B80', group: "等待动画", advanced: true, hint: '连续 3 秒没有新响应时，等待动画会渐变到此颜色' },
  ...
  messageBorderColor: { ...C('chat', '消息边框'), default: '', group: "消息外观", },
  ...
  ccBg: { ...C('cc', '中控区背景'), default: 'transparent', group: "外观风格", },
  ...
  inputPlaceholder: { ...C('cc', '占位提示颜色'), default: 'rgba(0,0,0,0.28)', group: "输入与状态", },
  inputSendBg: { ...C('cc', '发送按钮背景'), default: 'rgba(0,0,0,0.10)', group: "输入与状态", },
  inputBorderColor: { ...C('cc', '输入边框'), default: '', group: "输入与状态", },
  ...
  cliLineColor: { ...C('cc', '命令行边框颜色'), default: '', group: "输入与状态", },
  cliTextColor: { ...C('cc', '命令行文字颜色'), default: '', group: "输入与状态", },
  ...
  statusBg: { ...C('cc', '状态区背景'), default: 'transparent', group: "输入与状态", },
  ...
  ekgGreen: { ...C('cc', '活动波形正常状态'), default: '#4EBA65', group: "波形与用量", },
  ekgYellow: { ...C('cc', '活动波形警示状态'), default: '#FFC107', group: "波形与用量", noCssVar: true },
  ekgRed: { ...C('cc', '活动波形危险状态'), default: '#FF6B80', group: "波形与用量", noCssVar: true },
  barTrackColor: { ...C('cc', '用量条轨道'), default: 'rgba(0,0,0,0.18)', group: "波形与用量", advanced: true, noCssVar: true },
  barFillColor: { ...C('cc', '用量条填充'), default: '#4EBA65', group: "波形与用量", advanced: true, noCssVar: true },
  ...
  pillBg: { ...C('cc', '用量胶囊背景'), default: '#373737', group: "波形与用量", },
  pillText: { ...C('cc', '用量胶囊文字'), default: '#999999', group: "波形与用量", },
  prismOnColor: { ...C('cc', 'Prism 已开启状态'), default: '#4EBA65', group: "波形与用量", },
  ...
  modeAutoColor: { ...C('cc', '自动模式颜色'), default: '#FFC107', group: "控件样式", advanced: true },
  modeEditColor: { ...C('cc', '编辑模式颜色'), default: '#A2A9E4', group: "控件样式", advanced: true },

  // ── right ──
  rightBg: { ...C('right', '右栏背景色'), default: 'rgba(0,0,0,0.02)', group: "外观" },
