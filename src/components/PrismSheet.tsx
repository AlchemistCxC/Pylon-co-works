...
// ═══════════════════════════════════════════════════════════
function BotsTab() {
  const bots = [{id:'bot-1',name:'Agent A',status:'online'},{id:'bot-2',name:'Agent B',status:'online'}]
  ...
  return <div className="ps-tab"><h3>系统</h3>
    <div className="ps-split">
      ...
      <div className="ps-detail">
        ...
        <div className="ps-field"><label>user_name</label><input className="ps-input" defaultValue=""/></div>
