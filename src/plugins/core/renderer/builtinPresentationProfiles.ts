...
const EXECUTION_SURFACE_TOKENS = Object.freeze({
  ...
  inputRadius: 12, ccVariant: 'glass', assistantDot: true,
...
export const BUILTIN_PRESENTATION_PROFILES: readonly PresentationProfileContribution[] = Object.freeze([
  ...
  },
  {
    ...
    tokens: {
      ...
      inputBorderColor: 'rgba(59,130,246,0.32)', inputFocusBorder: 'rgba(59,130,246,0.82)', inputRadius: 8,
      ccVariant: 'glass',
  ...
  },
  {
    ...
    tokens: {
      ...
      inputBorderColor: 'rgba(128,102,63,0.24)', inputFocusBorder: 'rgba(128,102,63,0.52)', inputRadius: 4,
      ccVariant: 'pill',
  ...
  },
  {
    ...
    tokens: {
      ...
      inputBorderColor: 'rgba(148,163,184,0.30)', inputFocusBorder: 'rgba(99,102,241,0.72)', inputRadius: 16,
      ccVariant: 'glass',
