...
const BUILTIN: readonly CommandSetDescriptor[] = Object.freeze([
  { name: 'model', description: '切换模型', inputHint: ' <modelId>', agentPromptSnippet: '/model <modelId>：切换到 Agent 宣告的模型 ID。', permission: 'read', priority: 10 },
  ...
  { name: 'mode', description: '切换权限模式', inputHint: ' <modeId>', agentPromptSnippet: '/mode <modeId>：切换到 Agent 宣告的权限模式 ID（如 default / plan / acceptEdits）。', permission: 'gate', priority: 60 },
])
