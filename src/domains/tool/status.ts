...
/** 工具视觉状态单一真值数组（Skin Schema componentVariants 等动态枚举来源） */
export const TOOL_VISUAL_STATES = ['queued', 'running', 'waiting', 'completed', 'failed', 'cancelled', 'unknown'] as const
export type ToolVisualState = (typeof TOOL_VISUAL_STATES)[number]
