...
const FIXTURE_PATHS: Readonly<Record<string, string>> = {
  ...
  'claude-acp-wire.json': 'src/domains/workbench/normalizers/__tests__/fixtures/claude-acp-wire.json',
  ...
  'hermes-tool-call-start.json': 'src/domains/workbench/normalizers/__tests__/fixtures/hermes-tool-call-start.json',
  'hermes-tool-call-complete.json': 'src/domains/workbench/normalizers/__tests__/fixtures/hermes-tool-call-complete.json',
  'hermes-structured-results.json': 'src/domains/workbench/normalizers/__tests__/fixtures/hermes-structured-results.json',
