...
export const GLOBAL_PRESETS: GlobalPreset[] = [
  ...
  },
  {
    name: 'tokyo', label: 'Tokyo Night', theme: {
      ...
      toolOk: '#9ece6a', toolRun: '#7aa2f7', toolErr: '#f7768e', userTagBg: '#24283b', userTagText: '#bb9af7', toolIndicator: '●', toolIndicatorGlow: 0, toolIndicatorGlowColor: '', toolConnectorMode: 'none', toolConnectorColor: '#414868',
      ...
      statusBg:'transparent',statusBgImage:'',ekgWidth:140,ekgGreen:'#9ece6a',ekgYellow:'#e0af68',ekgRed:'#f7768e',barTrackColor:'#24283b',barFillColor:'#7aa2f7',barFillFollow:true,barHeight:8,pillBg:'#24283b',pillText:'#a9b1d6',prismOnColor:'#9ece6a',modelVariant:'minimal',modeVariant:'minimal',sendVariant:'minimal',attachVariant:'minimal',
  ...
  },
  {
    name: 'solarized', label: 'Solarized Light', theme: {
      ...
      toolOk:'#859900',toolRun:'#268bd2',toolErr:'#dc322f',userTagBg:'#eee8d5',userTagText:'#268bd2',toolIndicator:'●',toolIndicatorGlow:0,toolIndicatorGlowColor:'',toolConnectorMode:'none',toolConnectorColor:'#93a1a1',
