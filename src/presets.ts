...
export const GLOBAL_PRESETS: GlobalPreset[] = [
  // ── Claude Code CLI ──────────────────────────────────────────
  {
    ...
    theme: {
      ...
      ccPositions: {
        input:   { x: 2,  y: 2,  w: 95, h: 56 },
        context: { x: 2,  y: 64, w: 55, h: 16 },
        model:   { x: 59, y: 64, w: 26, h: 16 },
        mode:    { x: 87, y: 64, w: 11, h: 16 },
  ...
  // ── Glass Light ──────────────────────────────────────────────
  {
    ...
    theme: {
      ...
      ccPositions: {
        ...
        context: { x: 3,  y: 65, w: 58, h: 14 },
        model:   { x: 63, y: 65, w: 24, h: 18 },
        mode:    { x: 88, y: 65, w: 10, h: 18 },
        send:    { x: 86, y: 24, w: 6,  h: 12 },
        attach:  { x: 93, y: 24, w: 5,  h: 12 },
      },
