...
export const GLOBAL_PRESETS: GlobalPreset[] = [
  ...
  // ── Glass Light ──────────────────────────────────────────────
  {
    ...
    theme: {
      ...
      // cc — 玻璃中控区
      ccHeight: 130, ccBgHeight: 130, ccBg: 'rgba(255,255,255,0.20)', ccBgImage: '',
      ccStyle: 'bar', ccVariant: 'glass',
      barTrackColor: 'rgba(0,0,0,0.06)', barFillColor: '#22c55e', barFillFollow: true, barHeight: 8,
      ccPositions: {
      ...
      inputMode: 'default', cliLineWidth: 2, cliLineColor: '#6366f1', cliTextColor: '',
      ccHidden: [],
      statusBg: 'transparent', statusBgImage: '',
  ...
  // ── Nord Frost ───────────────────────────────────────────────
  {
    ...
    theme: {
      ...
      // cc — 冰蓝终端中控
      ccHeight: 130, ccBgHeight: 130, ccBg: '#252838', ccBgImage: '',
      ccStyle: 'wave', ccVariant: 'terminal',
      barTrackColor: 'rgba(136,192,208,0.10)', barFillColor: '#88c0d0', barFillFollow: true, barHeight: 7,
      ccPositions: {
        input:   { x: 3,  y: 3,  w: 94, h: 55 },
        ekg:     { x: 3,  y: 67, w: 30, h: 14 },
        pct:     { x: 35, y: 70, w: 8,  h: 12 },
