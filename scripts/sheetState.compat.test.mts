...
describe('sheetState reducer legacy compat', () => {
  ...
  it('9 kind 注册表与 createSheetState 容错', () => {
    ...
    expect(getWorkspaceRegistrySnapshot().workspaces.length, 'W1-01：9 kind 注册表（删 diff/changes/git-history，增 overview/search/history/browser/gateway）').toBe(9)
