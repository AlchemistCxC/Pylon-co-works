...
const sanitized = sanitizeHtml(
  '<div class="term-root unknown" title="safe" onclick="alert(1)" style="color:red;background-color:rgb(0, 0, 0)">'
  + '<span class="pl-k pl-syntax unknown" style="background-image:url(javascript:alert(1))">if</span>'
  + '<span class="term-match" aria-hidden="true" role="note" style="color:blue;position:fixed;left:0">text</span>'
...
assert.equal(
  sanitized,
  '<div class="term-root" title="safe" style="color: red; background-color: rgb(0, 0, 0)">'
    + '<span class="pl-k pl-syntax">if</span>'
    + '<span class="term-match" aria-hidden="true" role="note" style="color: blue">text</span>'
...
assert.ok(!sanitized.includes('position:fixed'))
