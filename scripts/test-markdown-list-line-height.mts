...
assert.equal(css.includes('.term-assistant { position:relative; padding:var(--ui-space-1) 0; white-space:normal; }'), true)
...
assert.equal(css.includes('line-height:var(--msg-line-height,var(--chat-line-height,1.35));'), true)
