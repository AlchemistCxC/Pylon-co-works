...
assert.match(source, /\? \(state\.sessionLiveStats\[toAgentContextKey\(sessionContext\)\]\?\.commands \?\? EMPTY_COMMANDS\)\s*: EMPTY_COMMANDS/,
  '有会话和无会话分支都应返回稳定的 EMPTY_COMMANDS（I01-W2 context key）')
