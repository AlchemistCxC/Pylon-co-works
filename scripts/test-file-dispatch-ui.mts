...
assert.match(bar, /\.sendMessage\(\{ agentId: ownerSession\.agentId, profileId: ownerSession\.profileId, source: targetSource, content: message, persona: ''/, '必须经 typed client 显式 owner + source + persona 空串')
