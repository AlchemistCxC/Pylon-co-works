...
const source = readFileSync(new URL('../src/components/cc/widgetRegistry.tsx', import.meta.url), 'utf8')
...
assert.equal(controlCenter.includes('theme.tokenDisplay ==='), false, 'PropertyPanel 不应再用第二套显示模式覆盖 ccStyle')
