...
const connectorPath = 'src/components/chat/ToolConnector.tsx'
...
requireToken(preview, 'pv-tool-connector-style--', 'preview connector style token')
requireToken(connector, 'useStore(s => s.toolConnectorMode)', 'tool connector store selector')
