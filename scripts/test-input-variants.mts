...
assert.match(customPresets, /inputVariant: 'cli'/)
assert.match(customPresets, /inputShowPlaceholder: true/)
assert.match(customPresets, /inputShowHistoryHint: true/)
assert.match(customPresets, /inputSubmitButtonMode: 'inline'/)
