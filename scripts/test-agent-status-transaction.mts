...
assert.equal(app.includes("listen<AgentStatusPayload>('pylon:agent-status'"), true)
assert.equal(settings.includes('agentClient.reconnectAgent()'), true)
assert.equal(settings.includes('agentClient.reloadAgents()'), true)
