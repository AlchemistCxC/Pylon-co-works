...
- `--json` 输出稳定的 `{ "report": { "candidates": [...], ... }, "diagnostics": [...], "preflight": [...] }` 文档（candidates 在 `report` 内；GUI 命令的返回体则是把检测快照拍平、顶层即 `candidates`，另带 `cached` 与 `probeMs`）。
